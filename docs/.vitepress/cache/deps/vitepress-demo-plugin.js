...
import { normalizeClass, normalizeStyle, toDisplayString } from "./chunk-JVSYCCQQ.js";
import { __commonJS, __toESM } from "./chunk-MTI3AIJG.js";
...
// ../node_modules/.pnpm/vitepress-demo-plugin@1.2.3_vitepress@1.0.0-rc.32_@algolia+client-search@5.18.0_@types+node@2_w5uvjtcxuh3senf4mhdjegcbkq/node_modules/vitepress-demo-plugin/dist/index.js
  ...
  var t = (function () {
    ...
    var r = {
      ...
      decompressFromUint8Array: function (o) {
        ...
        for (var c = new Array(o.length / 2), g = 0, h = c.length; g < h; g++) c[g] = o[g * 2] * 256 + o[g * 2 + 1];
        var m = [];
        return (
      ...
      _compress: function (o, c, g) {
        ...
        for (f = 0; f < o.length; f += 1)
          if (
            ((L = o.charAt(f)),
            Object.prototype.hasOwnProperty.call(S, L) || ((S[L] = A++), (C[L] = true)),
            (d = _ + L),
            ...
            if (Object.prototype.hasOwnProperty.call(C, _)) {
              if (_.charCodeAt(0) < 256) {
                for (h = 0; h < x; h++) (p = p << 1), v == c - 1 ? ((v = 0), k.push(g(p)), (p = 0)) : v++;
                for (m = _.charCodeAt(0), h = 0; h < 8; h++)
                  (p = (p << 1) | (m & 1)), v == c - 1 ? ((v = 0), k.push(g(p)), (p = 0)) : v++, (m = m >> 1);
              } else {
                for (m = 1, h = 0; h < x; h++) (p = (p << 1) | m), v == c - 1 ? ((v = 0), k.push(g(p)), (p = 0)) : v++, (m = 0);
...
function Ht() {
  ...
  (e.prototype.clone_empty = function () {
    ...
    (e.prototype.has_match = function (n) {
      for (var s = this.__items.length - 1; s >= 0; s--) if (this.__items[s].match(n)) return true;
      return false;
    }),
    ...
    (e.prototype._allow_wrap = function () {
      if (this._should_wrap()) {
        ...
        return (
          n.set_indent(this.__wrap_point_indent_count, this.__wrap_point_alignment_count),
          (n.__items = this.__items.slice(this.__wrap_point_index)),
          (this.__items = this.__items.slice(0, this.__wrap_point_index)),
          (n.__character_count += this.__character_count - this.__wrap_point_character_count),
          (this.__character_count = this.__wrap_point_character_count),
          n.__items[0] === " " && (n.__items.splice(0, 1), (n.__character_count -= 1)),
          true
        );
      }
      return false;
...
`);
    ...
    (e.prototype.toString = function () {
      ...
      return (
        this.is_empty()
          ? this.__parent.indent_empty_lines && (n = this.__parent.get_indent_string(this.__indent_count))
          : ((n = this.__parent.get_indent_string(this.__indent_count, this.__alignment_count)), (n += this.__items.join(""))),
        n
      );
    });
  function t(n, s) {
    (this.__cache = [""]),
      ...
      n.indent_with_tabs || (this.__indent_string = new Array(n.indent_size + 1).join(n.indent_char)),
      (s = s || ""),
      n.indent_level > 0 && (s = new Array(n.indent_level + 1).join(this.__indent_string)),
...
` && (l = l.replace(/[\n]/g, n)),
    ...
    (i.prototype.set_indent = function (n, s) {
      return (
        ...
        this.__lines.length > 1 ? (this.current_line.set_indent(n, s), true) : (this.current_line.set_indent(), false)
      );
    }),
    ...
    hi ||
      ...
      (function (e) {
        ...
        (e.identifier = new RegExp(u + r, "g")),
          ...
          (e.identifierMatch = new RegExp("(?:" + l + "|[" + i + n + s + "])+")),
          (e.newline = /[\n\r\u2028\u2029]/),
...
function Xt() {
  ...
  return (
    ...
    (t.prototype.readUntil = function (i, n) {
      ...
      return (
        u ? ((l = u.index), n && (l += u[0].length)) : (l = this.__input_length),
    ...
    (t.prototype.get_regexp = function (i, n) {
      var s = null,
        l = "g";
      return (
        n && e && (l = "y"), typeof i == "string" && i !== "" ? (s = new RegExp(i, l)) : i && (s = new RegExp(i.source, l)), s
      );
    }),
...
function dt() {
  ...
  function e(t, i) {
    (this._input = t),
      ...
      i &&
        ((this._starting_pattern = this._input.get_regexp(i._starting_pattern, true)),
...
function Es() {
  ...
  function t(i, n) {
    e.call(this, i, n),
      n ? (this._line_regexp = this._input.get_regexp(n._line_regexp)) : this.__set_whitespace_patterns("", ""),
  ...
  return (
    ...
    (t.prototype.__set_whitespace_patterns = function (i, n) {
      (i += "\\t "),
        (n += "\\n\\r"),
        (this._match_pattern = this._input.get_regexp("[" + i + n + "]+", true)),
    ...
    (t.prototype.__split = function (i, n) {
      i.lastIndex = 0;
      for (var s = 0, l = [], u = i.exec(n); u; ) l.push(n.substring(s, u.index)), (s = u.index + u[0].length), (u = i.exec(n));
  ...
  return (
    (l.prototype.tokenize = function () {
      ...
      for (var u, r = new t(s.START, ""), o = null, c = [], g = new i(); r.type !== s.EOF; ) {
        for (u = this._get_next_token(r, o); this._is_comment(u); ) g.add(u), (u = this._get_next_token(r, o));
        g.isEmpty() || ((u.comments_before = g), (g = new i())),
          (u.parent = o),
          this._is_opening(u)
            ? (c.push(o), (o = u))
            : o && this._is_closing(u, o) && ((u.opened = o), (o.closed = u), (o = c.pop()), (u.parent = o)),
          (u.previous = r),
          (r.next = u),
          this.__tokens.add(u),
          (r = u);
    ...
    (l.prototype._create_token = function (u, r) {
      var o = new t(u, r, this._patterns.whitespace.newline_count, this._patterns.whitespace.whitespace_before_token);
      return o;
    }),
...
function Vt() {
  ...
  function e(t, i) {
    (t = typeof t == "string" ? t : t.source),
      ...
      (this.__directives_block_pattern = new RegExp(t + / beautify( \w+[:]\w+)+ /.source + i, "g")),
      (this.__directive_pattern = / (\w+)[:](\w+)/g),
      (this.__directives_end_ignore_pattern = new RegExp(t + /\sbeautify\signore:end\s/.source + i, "g"));
  }
  return (
    (e.prototype.get_directives = function (t) {
      ...
      for (var n = this.__directive_pattern.exec(t); n; ) (i[n[1]] = n[2]), (n = this.__directive_pattern.exec(t));
      return i;
    }),
...
function ln() {
  ...
  function i(n, s) {
    e.call(this, n, s),
      ...
      s &&
        ((this.__template_pattern = this._input.get_regexp(s.__template_pattern)),
  ...
  return (
    ...
    (i.prototype.read = function () {
      ...
      this._match_pattern
        ...
        : (n = this._input.read(this._starting_pattern, this.__template_pattern));
    ...
    (i.prototype.__set_templated_pattern = function () {
      var n = [];
      this._disabled.php || n.push(this.__patterns.php._starting_pattern.source),
        this._disabled.handlebars || n.push(this.__patterns.handlebars._starting_pattern.source),
        this._disabled.erb || n.push(this.__patterns.erb._starting_pattern.source),
        ...
        this._disabled.smarty || n.push(this.__patterns.smarty._starting_pattern.source),
        this._until_pattern && n.push(this._until_pattern.source),
        (this.__template_pattern = this._input.get_regexp("(?:" + n.join("|") + ")"));
    }),
    (i.prototype._read_template = function () {
      ...
      if (s === "<") {
        ...
        !this._disabled.php && !this._excluded.php && l === "?" && (n = n || this.__patterns.php.read()),
          !this._disabled.erb && !this._excluded.erb && l === "%" && (n = n || this.__patterns.erb.read());
      } else
        s === "{" &&
          ...
          this._disabled.django ||
            (!this._excluded.django && !this._excluded.handlebars && (n = n || this.__patterns.django_value.read()),
            this._excluded.django ||
              ((n = n || this.__patterns.django_comment.read()), (n = n || this.__patterns.django.read()))),
...
function et() {
  ...
  var L = new RegExp(C),
    d = "continue,try,throw,return,var,let,const,if,switch,case,default,for,while,break,function,import,export".split(","),
    _ = d.concat([
      "do",
      "in",
      "of",
  ...
  (x.prototype = new t()),
    ...
    (x.prototype._is_closing = function (p, v) {
      return (
        ...
        v &&
        ((p.text === "]" && v.text === "[") || (p.text === ")" && v.text === "(") || (p.text === "}" && v.text === "{"))
      );
    }),
...
`
          ...
          !(p.type === o.DOT || (p.type === o.RESERVED && (p.text === "set" || p.text === "get"))) && b.test(v)
            ? (v === "in" || v === "of") && (p.type === o.WORD || p.type === o.STRING)
              ? this._create_token(o.OPERATOR, v)
              : this._create_token(o.RESERVED, v)
            : this._create_token(o.WORD, v)
        );
      if (((v = this.__patterns.number.read()), v !== "")) return this._create_token(o.WORD, v);
    }),
    ...
    (x.prototype._read_pair = function (p, v) {
      var f = null;
      return (
        p === "#" && v === "{" && (f = this._create_token(o.START_BLOCK, p + v)), f && (this._input.next(), this._input.next()), f
      );
    }),
...
`
        ...
        if (((v = this.__patterns.html_comment_start.read()), v)) {
          for (; this._input.hasNext() && !this._input.testChar(s.newline); ) v += this._input.next();
...
`
            ...
            (v.directives = O);
        } else this._input.peek(1) === "/" && ((f = this.__patterns.comment.read()), (v = this._create_token(o.COMMENT, f)));
      }
      return v;
    }),
    (x.prototype._read_string = function (p) {
      if (p === "`" || p === "'" || p === '"') {
        ...
        return (
          ...
          p === "`" ? (v += this._read_string_recursive("`", true, "${")) : (v += this._read_string_recursive(p)),
...
`
    ...
    (x.prototype._allow_regexp_or_xml = function (p) {
      return (
        (p.type === o.RESERVED && r(p.text, ["return", "case", "throw", "else", "do", "typeof", "yield"])) ||
        (p.type === o.END_EXPR &&
          p.text === ")" &&
    ...
    (x.prototype._read_regexp = function (p, v) {
      if (p === "/" && this._allow_regexp_or_xml(v)) {
        for (
          ...
          this._input.hasNext() && (O || a || this._input.peek() !== p) && !this._input.testChar(s.newline);
          ...
          (f += this._input.peek()),
            O
              ? (O = false)
              : ((O = this._input.peek() === "\\"),
                this._input.peek() === "[" ? (a = true) : this._input.peek() === "]" && (a = false)),
            this._input.next();
        return (
          this._input.peek() === p && ((f += this._input.next()), (f += this._input.read(s.identifier))),
  ...
  function k(p) {
    for (var v = "", f = 0, O = new e(p), a = null; O.hasNext(); )
      if (((a = O.match(/([\s]|[^\\]|\\\\)+/g)), a && (v += a[0]), O.peek() === "\\")) {
        ...
        else if (O.peek() === "u") (a = O.match(/u([0-9A-Fa-f]{4})/g)), a || (a = O.match(/u\{([0-9A-Fa-f]+)\}/g));
        else {
          (v += "\\"), O.hasNext() && (v += O.next());
          continue;
        }
        if (!a || ((f = parseInt(a[1], 16)), f > 126 && f <= 255 && a[0].indexOf("x") === 0)) return p;
        (f >= 0 && f < 32) || f > 1114111
          ? (v += "\\" + a[0])
          : f === 34 || f === 39 || f === 92
...
` &&
              ...
              (w += this._input.next()))
            : f &&
              (f === "${" && w === "$" && this._input.peek() === "{" && (w += this._input.next()),
              f === w &&
                (p === "`" ? (w += this._read_string_recursive("}", v, "`")) : (w += this._read_string_recursive("`", v, "${")),
...
function xs() {
  ...
  var S = ["case", "return", "do", "if", "throw", "else", "await", "break", "continue", "async"],
...
`));
  ...
  function v(a, E) {
    for (var w = 0, M = a.length, P; w < M; w++) if (((P = a[w]), P && P.indexOf(E) !== 0)) return false;
    return true;
  }
  function f(a, E) {
    (E = E || {}),
  ...
  return (
    ...
    (f.prototype.print_newline = function (a, E) {
      if (
        ...
        for (
          ...
          this._flags.mode === _.Statement && !(this._flags.if_block && h(w, "else")) && !this._flags.do_block;
    ...
    (f.prototype.print_token_line_indentation = function (a) {
      this._output.just_added_newline() &&
        (this._options.keep_array_indentation && a.newlines && (a.text === "[" || x(this._flags.mode))
    ...
    (f.prototype.print_token = function (a) {
      ...
      if (
        ...
        this._output.previous_line.is_empty() &&
          (this._output.previous_line.push(E), this._output.trim(true), this._output.current_line.pop(), this._output.trim()),
      ...
      this.print_token_line_indentation(a),
        ...
        this._output.previous_token_wrapped && (this._flags.multiline_frame = true);
    }),
    ...
    (f.prototype.restore_mode = function () {
      this._flag_store.length > 0 &&
        ...
        this._previous_flags.mode === _.Statement && b(this._output, this._previous_flags),
        this._output.set_indent(this._flags.indentation_level, this._flags.alignment));
    }),
    (f.prototype.start_of_object_property = function () {
      return (
        ...
        ((this._flags.last_token.text === ":" && this._flags.ternary_depth === 0) || m(this._flags.last_token, ["get", "set"]))
      );
    }),
    (f.prototype.start_of_statement = function (a) {
      var E = false;
      return (
        (E = E || (m(this._flags.last_token, ["var", "let", "const"]) && a.type === r.WORD)),
        (E = E || h(this._flags.last_token, "do")),
        (E =
          E ||
          (!(this._flags.parent.mode === _.ObjectLiteral && this._flags.mode === _.Statement) &&
            m(this._flags.last_token, O) &&
            !a.newlines)),
        (E = E || (h(this._flags.last_token, "else") && !(h(a, "if") && !a.comments_before))),
        (E =
          E ||
          (this._flags.last_token.type === r.END_EXPR &&
            (this._previous_flags.mode === _.ForInitializer || this._previous_flags.mode === _.Conditional))),
        (E =
          E ||
        ...
        E
          ? (this.set_mode(_.Statement),
            ...
            this.start_of_object_property() || this.allow_wrap_or_preserved_newline(a, m(a, ["do", "for", "if", "while"])),
            true)
          : false
      );
    }),
    (f.prototype.handle_start_expr = function (a) {
      ...
      if (a.text === "[") {
        if (this._flags.last_token.type === r.WORD || this._flags.last_token.text === ")") {
          m(this._flags.last_token, l) && (this._output.space_before_token = true),
            this.print_token(a),
            this.set_mode(E),
            this.indent(),
            this._options.space_in_paren && (this._output.space_before_token = true);
          return;
        }
        (E = _.ArrayLiteral),
          x(this._flags.mode) &&
          ...
          o(this._flags.last_token.type, [r.START_EXPR, r.END_EXPR, r.WORD, r.OPERATOR, r.DOT]) ||
            (this._output.space_before_token = true);
      } else {
        if (this._flags.last_token.type === r.RESERVED)
          this._flags.last_token.text === "for"
            ? ((this._output.space_before_token = this._options.space_before_conditional), (E = _.ForInitializer))
            : o(this._flags.last_token.text, ["if", "while", "switch"])
              ? ((this._output.space_before_token = this._options.space_before_conditional), (E = _.Conditional))
              : o(this._flags.last_word, ["await", "async"])
                ? (this._output.space_before_token = true)
                : this._flags.last_token.text === "import" && a.whitespace_before === ""
                  ? (this._output.space_before_token = false)
                  : (o(this._flags.last_token.text, l) || this._flags.last_token.text === "catch") &&
                    (this._output.space_before_token = true);
          ...
          if (this._options.space_after_named_function && w) {
            ...
            m(w, ["async", "function"]) || (w.text === "*" && m(M, ["async", "function"]))
              ? (this._output.space_before_token = true)
              : this._flags.mode === _.ObjectLiteral
                ? (w.text === "{" || w.text === "," || (w.text === "*" && (M.text === "{" || M.text === ","))) &&
                  (this._output.space_before_token = true)
                : this._flags.parent && this._flags.parent.class_start_block && (this._output.space_before_token = true);
          }
        ...
        ((this._flags.last_token.type === r.RESERVED &&
          ...
          (this._flags.last_token.text === "*" &&
            (o(this._last_last_text, ["function", "yield"]) ||
              (this._flags.mode === _.ObjectLiteral && o(this._last_last_text, ["{", ","]))))) &&
          (this._output.space_before_token = this._options.space_after_anon_function);
      }
      this._flags.last_token.text === ";" || this._flags.last_token.type === r.START_BLOCK
        ? this.print_newline()
        : (this._flags.last_token.type === r.END_EXPR ||
    ...
    (f.prototype.handle_end_expr = function (a) {
      ...
      this.handle_whitespace_and_comments(a),
        this._flags.multiline_frame &&
          this.allow_wrap_or_preserved_newline(a, a.text === "]" && x(this._flags.mode) && !this._options.keep_array_indentation),
        this._options.space_in_paren &&
          (this._flags.last_token.type === r.START_EXPR && !this._options.space_in_empty_paren
        ...
        this._flags.do_while &&
          ...
          ((this._previous_flags.mode = _.Expression), (this._flags.do_block = false), (this._flags.do_while = false));
    }),
    (f.prototype.handle_start_block = function (a) {
      this.handle_whitespace_and_comments(a);
      var E = this._tokens.peek(),
        w = this._tokens.peek(1);
      this._flags.last_word === "switch" && this._flags.last_token.type === r.END_EXPR
        ? (this.set_mode(_.BlockStatement), (this._flags.in_case_statement = true))
        : this._flags.case_body
          ? this.set_mode(_.BlockStatement)
          : w &&
              ((o(w.text, [":", ","]) && o(E.type, [r.STRING, r.WORD, r.RESERVED])) ||
                (o(E.text, ["get", "set", "..."]) && o(w.type, [r.WORD, r.RESERVED])))
            ? o(this._last_last_text, ["class", "interface"]) && !o(w.text, [":", ","])
              ? this.set_mode(_.BlockStatement)
              : this.set_mode(_.ObjectLiteral)
            : this._flags.last_token.type === r.OPERATOR && this._flags.last_token.text === "=>"
              ? this.set_mode(_.BlockStatement)
              : o(this._flags.last_token.type, [r.EQUALS, r.START_EXPR, r.COMMA, r.OPERATOR]) ||
                  m(this._flags.last_token, ["return", "throw", "import", "default"])
                ? this.set_mode(_.ObjectLiteral)
                : this.set_mode(_.BlockStatement),
      ...
      var M = !E.comments_before && E.text === "}",
        P = M && this._flags.last_word === "function" && this._flags.last_token.type === r.END_EXPR;
      ...
      (this._options.brace_style === "expand" || (this._options.brace_style === "none" && a.newlines)) &&
      !this._flags.inline_frame
        ? this._flags.last_token.type !== r.OPERATOR &&
          (P ||
            this._flags.last_token.type === r.EQUALS ||
            (m(this._flags.last_token, S) && this._flags.last_token.text !== "else"))
          ? (this._output.space_before_token = true)
          : this.print_newline(false, true)
        : (x(this._previous_flags.mode) &&
            (this._flags.last_token.type === r.START_EXPR || this._flags.last_token.type === r.COMMA) &&
            ((this._flags.last_token.type === r.COMMA || this._options.space_in_paren) &&
              (this._output.space_before_token = true),
            (this._flags.last_token.type === r.COMMA ||
              (this._flags.last_token.type === r.START_EXPR && this._flags.inline_frame)) &&
              (this.allow_wrap_or_preserved_newline(a),
              (this._previous_flags.multiline_frame = this._previous_flags.multiline_frame || this._flags.multiline_frame),
              (this._flags.multiline_frame = false))),
          this._flags.last_token.type !== r.OPERATOR &&
            this._flags.last_token.type !== r.START_EXPR &&
            (o(this._flags.last_token.type, [r.START_BLOCK, r.SEMICOLON]) && !this._flags.inline_frame
              ? this.print_newline()
              : (this._output.space_before_token = true))),
        this.print_token(a),
        this.indent(),
        !M && !(this._options.brace_preserve_inline && this._flags.inline_frame) && this.print_newline();
    }),
    (f.prototype.handle_end_block = function (a) {
      for (this.handle_whitespace_and_comments(a); this._flags.mode === _.Statement; ) this.restore_mode();
    ...
    (f.prototype.handle_word = function (a) {
      if (a.type === r.RESERVED) {
        if (o(a.text, ["set", "get"]) && this._flags.mode !== _.ObjectLiteral) a.type = r.WORD;
        else if (a.text === "import" && o(this._tokens.peek().text, ["(", "."])) a.type = r.WORD;
        else if (o(a.text, ["as", "from"]) && !this._flags.import_block) a.type = r.WORD;
      ...
      if (
        (this.start_of_statement(a)
          ? m(this._flags.last_token, ["var", "let", "const"]) && a.type === r.WORD && (this._flags.declaration_statement = true)
          : a.newlines &&
              !k(this._flags.mode) &&
              (this._flags.last_token.type !== r.OPERATOR ||
                this._flags.last_token.text === "--" ||
                this._flags.last_token.text === "++") &&
              this._flags.last_token.type !== r.EQUALS &&
              (this._options.preserve_newlines || !m(this._flags.last_token, ["var", "let", "const", "set", "get"]))
      ...
      if (this._flags.if_block)
        if (!this._flags.else_block && h(a, "else")) this._flags.else_block = true;
        else {
          for (; this._flags.mode === _.Statement; ) this.restore_mode();
      ...
      if (
        ...
        (o(this._flags.last_token.text, ["}", ";"]) ||
          (this._output.just_added_newline() &&
            !(o(this._flags.last_token.text, ["(", "[", "{", ":", "=", ","]) || this._flags.last_token.type === r.OPERATOR))) &&
          !this._output.just_added_blankline() &&
          !a.comments_before &&
          (this.print_newline(), this.print_newline(true)),
          this._flags.last_token.type === r.RESERVED || this._flags.last_token.type === r.WORD
            ? m(this._flags.last_token, ["get", "set", "new", "export"]) || m(this._flags.last_token, O)
              ? (this._output.space_before_token = true)
              : h(this._flags.last_token, "default") && this._last_last_text === "export"
                ? (this._output.space_before_token = true)
            ...
            : this._flags.last_token.type === r.OPERATOR || this._flags.last_token.text === "="
              ? (this._output.space_before_token = true)
              : (!this._flags.multiline_frame && (k(this._flags.mode) || x(this._flags.mode))) || this.print_newline(),
          this.print_token(a),
      ...
      if (
        (this._flags.last_token.type === r.END_BLOCK
          ? this._previous_flags.inline_frame
            ...
            : m(a, ["else", "catch", "finally", "from"])
              ...
              : (w = "NEWLINE")
          : this._flags.last_token.type === r.SEMICOLON && this._flags.mode === _.BlockStatement
            ? (w = "NEWLINE")
                ...
                : this._flags.last_token.type === r.RESERVED ||
                  ...
                  : this._flags.last_token.type === r.START_BLOCK
                    ? this._flags.inline_frame
                      ? (w = "SPACE")
                      : (w = "NEWLINE")
                    : this._flags.last_token.type === r.END_EXPR && ((this._output.space_before_token = true), (w = "NEWLINE")),
        m(a, l) &&
          this._flags.last_token.text !== ")" &&
          (this._flags.inline_frame || this._flags.last_token.text === "else" || this._flags.last_token.text === "export"
            ? (w = "SPACE")
            : (w = "NEWLINE")),
        m(a, ["else", "catch", "finally"]))
      )
        if (
          (!(this._flags.last_token.type === r.END_BLOCK && this._previous_flags.mode === _.BlockStatement) ||
            this._options.brace_style === "expand" ||
            this._options.brace_style === "end-expand" ||
            (this._options.brace_style === "none" && a.newlines)) &&
          !this._flags.inline_frame
        ...
        w === "NEWLINE"
          ? m(this._flags.last_token, S)
            ? (this._output.space_before_token = true)
            : this._flags.last_token.text === "declare" && m(a, ["var", "let", "const"])
              ? (this._output.space_before_token = true)
              : this._flags.last_token.type !== r.END_EXPR
                ? (this._flags.last_token.type !== r.START_EXPR || !m(a, ["var", "let", "const"])) &&
                  this._flags.last_token.text !== ":" &&
                  (h(a, "if") && h(a.previous, "else") ? (this._output.space_before_token = true) : this.print_newline())
                : m(a, l) && this._flags.last_token.text !== ")" && this.print_newline()
          : this._flags.multiline_frame &&
              x(this._flags.mode) &&
              this._flags.last_token.text === "," &&
              this._last_last_text === "}"
            ? this.print_newline()
            : w === "SPACE" && (this._output.space_before_token = true);
      a.previous && (a.previous.type === r.WORD || a.previous.type === r.RESERVED) && (this._output.space_before_token = true),
        this.print_token(a),
        (this._flags.last_word = a.text),
        a.type === r.RESERVED &&
          (a.text === "do"
            ...
            : a.text === "if"
              ...
              : a.text === "import"
                ...
                : this._flags.import_block && h(a, "from") && (this._flags.import_block = false));
    }),
    (f.prototype.handle_semicolon = function (a) {
      ...
      for (
        var E = this._tokens.peek();
        this._flags.mode === _.Statement && !(this._flags.if_block && h(E, "else")) && !this._flags.do_block;
    ...
    (f.prototype.handle_string = function (a) {
      (a.text.startsWith("`") &&
        ...
        (this.start_of_statement(a)
          ? (this._output.space_before_token = true)
          : (this.handle_whitespace_and_comments(a),
            this._flags.last_token.type === r.RESERVED || this._flags.last_token.type === r.WORD || this._flags.inline_frame
              ? (this._output.space_before_token = true)
              : this._flags.last_token.type === r.COMMA ||
                  this._flags.last_token.type === r.START_EXPR ||
                  this._flags.last_token.type === r.EQUALS ||
    ...
    (f.prototype.handle_equals = function (a) {
      this.start_of_statement(a) || this.handle_whitespace_and_comments(a),
        this._flags.declaration_statement && (this._flags.declaration_assignment = true),
        (this._output.space_before_token = true),
        this.print_token(a),
        (this._output.space_before_token = true);
    }),
    (f.prototype.handle_comma = function (a) {
      this.handle_whitespace_and_comments(a, true),
        ...
        this._flags.declaration_statement
          ? (k(this._flags.parent.mode) && (this._flags.declaration_assignment = false),
            this._flags.declaration_assignment
              ? ((this._flags.declaration_assignment = false), this.print_newline(false, true))
              : this._options.comma_first && this.allow_wrap_or_preserved_newline(a))
          : this._flags.mode === _.ObjectLiteral ||
              (this._flags.mode === _.Statement && this._flags.parent.mode === _.ObjectLiteral)
            ? (this._flags.mode === _.Statement && this.restore_mode(), this._flags.inline_frame || this.print_newline())
            : this._options.comma_first && this.allow_wrap_or_preserved_newline(a);
    }),
    (f.prototype.handle_operator = function (a) {
      var E =
          ...
          (m(this._flags.last_token, ["function", "yield"]) ||
            o(this._flags.last_token.type, [r.START_BLOCK, r.COMMA, r.END_BLOCK, r.SEMICOLON])),
        w =
          o(a.text, ["-", "+"]) &&
          (o(this._flags.last_token.type, [r.START_BLOCK, r.START_EXPR, r.EQUALS, r.OPERATOR]) ||
      ...
      if (
        ...
        this.print_token(a),
          ...
          this._tokens.peek().type !== r.START_BLOCK
            ? (this.indent(), this.print_newline(), (this._flags.case_block = false))
            : ((this._flags.case_block = true), (this._output.space_before_token = true));
        return;
      }
      var P = true,
        j = true,
      ...
      if (E) {
        ...
        if (
          ((this._flags.last_token.type === r.COMMA || this._flags.last_token.type === r.START_EXPR) &&
            this.allow_wrap_or_preserved_newline(a),
          (P = false),
          (j = false),
          ...
          $ && (this._previous_flags.if_block || this._previous_flags.else_block) && this.restore_mode(),
            this.print_newline($, true);
        }
        this._flags.last_token.text === ";" && k(this._flags.mode) && (P = true),
          this._flags.last_token.type === r.RESERVED
            ? (P = true)
            : this._flags.last_token.type === r.END_EXPR
              ? (P = !(this._flags.last_token.text === "]" && (a.text === "--" || a.text === "++")))
              : this._flags.last_token.type === r.OPERATOR &&
                ((P = o(a.text, ["--", "-", "++", "+"]) && o(this._flags.last_token.text, ["--", "-", "++", "+"])),
                o(a.text, ["+", "-"]) && o(this._flags.last_token.text, ["--", "++"]) && (j = true)),
          ((this._flags.mode === _.BlockStatement && !this._flags.inline_frame) || this._flags.mode === _.Statement) &&
    ...
    (f.prototype.handle_block_comment = function (a, E) {
      if (this._output.raw) {
        this._output.add_raw_token(a),
          a.directives && a.directives.preserve === "end" && (this._output.raw = this._options.test_output_raw);
        return;
      }
      if (a.directives) {
        this.print_newline(false, E),
    ...
    (f.prototype.print_block_commment = function (a, E) {
      ...
      if (
        ...
        for (w = w.slice(1), P = p(w, "*"), j = v(w, F), P && (this._flags.alignment = 1), M = 0; M < w.length; M++)
          P
            ? (this.print_token_line_indentation(a), this._output.add_token(c(w[M])))
            : j && w[M]
              ? (this.print_token_line_indentation(a), this._output.add_token(w[M].substring(y)))
              : (this._output.current_line.set_indent(-1), this._output.add_token(w[M])),
            this.print_newline(false, E);
    ...
    (f.prototype.handle_dot = function (a) {
      this.start_of_statement(a) || this.handle_whitespace_and_comments(a, true),
        this._flags.last_token.text.match("^[0-9]+$") && (this._output.space_before_token = true),
        m(this._flags.last_token, S)
          ? (this._output.space_before_token = false)
          : this.allow_wrap_or_preserved_newline(a, this._flags.last_token.text === ")" && this._options.break_chained_methods),
...
`
      ...
      (this._output = new t(this._options, C)),
        ...
        (this._ch = null);
      for (
        var L = 0, d = false, _ = false, b = false, A = false, x = false, k = this._ch, p = false, v, f, O;
        ...
        if (this._ch === "/" && this._input.peek() === "*") {
          ...
          w.match(/[ :]$/) &&
            ((w = this.eatString(": ").replace(/\s+$/, "")), this.print_string(w), (this._output.space_before_token = true)),
            L === 0 && w.indexOf(":") !== -1 && ((_ = true), this.indent());
        } else if (this._ch === "@")
          if ((this.preserveSingleSpace(f), this._input.peek() === "{")) this.print_string(this._ch + this.eatString("}"));
          else {
            this.print_string(this._ch);
            var M = this._input.peekUntilAfter(/[: ,;{}()[\]\/='"]/g);
            M.match(/[ :]$/) &&
              ((M = this.eatString(": ").replace(/\s+$/, "")), this.print_string(M), (this._output.space_before_token = true)),
              L === 0 && M.indexOf(":") !== -1
                ? ((_ = true), this.indent())
                : M in this.NESTED_AT_RULE
                  ? ((this._nestedLevel += 1), M in this.CONDITIONAL_GROUP_RULE && (b = true))
                  : L === 0 && !_ && (A = true);
          }
        else if (this._ch === "#" && this._input.peek() === "{")
          ...
          _ && ((_ = false), this.outdent()),
            (A = false),
            b ? ((b = false), (d = this._indentLevel >= this._nestedLevel)) : (d = this._indentLevel >= this._nestedLevel - 1),
            ...
            this._options.brace_style === "expand"
              ...
              : (O === "(" ? (this._output.space_before_token = false) : O !== "," && this.indent(), this.print_string(this._ch)),
            this.eatWhitespace(true),
            this._output.add_new_line();
        else if (this._ch === "}")
          this.outdent(),
            ...
            this._input.peek() === ")" &&
              (this._output.trim(true), this._options.brace_style === "expand" && this._output.add_new_line(true));
        else if (this._ch === ":") {
          ...
          (d || b) && !(this._input.lookBack("&") || this.foundNestedPseudoClass()) && !this._input.lookBack("(") && !A && L === 0
            ? (this.print_string(":"),
              _ || ((_ = true), (this._output.space_before_token = true), this.eatWhitespace(true), this.indent()))
            : (this._input.lookBack(" ") && (this._output.space_before_token = true),
          ...
          (p = false),
            L === 0
              ...
              : (this.print_string(this._ch), this.eatWhitespace(true), (this._output.space_before_token = true));
        else if (this._ch === "(")
          if (this._input.lookBack("url"))
            this.print_string(this._ch),
              ...
              this._ch === ")" || this._ch === '"' || this._ch === "'"
                ? this._input.back()
                : this._ch && (this.print_string(this._ch + this.eatString(")")), L && (L--, this.outdent()));
          else {
            var F = false;
          ...
          this.print_string(this._ch),
            this.eatWhitespace(true),
            this._options.selector_separator_newline && (!_ || x) && L === 0 && !A
              ? this._output.add_new_line()
              : (this._output.space_before_token = true);
        else if ((this._ch === ">" || this._ch === "+" || this._ch === "~") && !_ && L === 0)
          this._options.space_around_combinator
            ? ((this._output.space_before_token = true), this.print_string(this._ch), (this._output.space_before_token = true))
            : (this.print_string(this._ch), this.eatWhitespace(), this._ch && r.test(this._ch) && (this._ch = ""));
        else if (this._ch === "]") this.print_string(this._ch);
        else if (this._ch === "[") this.preserveSingleSpace(f), this.print_string(this._ch);
        else if (this._ch === "=") this.eatWhitespace(), this.print_string("="), r.test(this._ch) && (this._ch = "");
  ...
  return (
    ...
    (r.prototype._is_closing = function (o, c) {
      return (
        ...
        (o.type === l.CONTROL_FLOW_CLOSE && o.text === "}" && c.text.endsWith("{"))
      );
    }),
    ...
    (r.prototype._read_comment_or_cdata = function (o) {
      ...
      if (o === "<") {
        ...
        m === "!" &&
          ...
          g
            ? ((h = u.get_directives(g)), h && h.ignore === "start" && (g += u.readIgnored(this._input)))
    ...
    (r.prototype._read_processing = function (o) {
      ...
      if (o === "<") {
        var m = this._input.peek(1);
        (m === "!" || m === "?") &&
          ((g = this.__patterns.conditional_comment.read()), (g = g || this.__patterns.processing.read())),
          g && ((c = this._create_token(l.COMMENT, g)), (c.directives = h));
      }
      return c;
    }),
      ...
      return (
        (!c || c.type === l.CONTROL_FLOW_OPEN) &&
          ...
          (this._input.peek(2) === "!"
            ...
            : ((g = this.__patterns.handlebars_open.read()), (h = this._create_token(l.TAG_OPEN, g)))),
        h
      );
    }),
    (r.prototype._read_control_flows = function (o, c) {
      var g = "",
        h = null;
      if (!this._options.templating.includes("angular") || !this._options.indent_handlebars) return h;
      if (o === "@") {
        if (((g = this.__patterns.angular_control_flow_start.read()), g === "")) return h;
        ...
        o === "}" &&
          ...
          ((g = this._input.next()), (h = this._create_token(l.CONTROL_FLOW_CLOSE, g)));
      return h;
    }),
    (r.prototype._read_close = function (o, c) {
      ...
      return (
        c &&
          c.type === l.TAG_OPEN &&
          (c.text[0] === "<" && (o === ">" || (o === "/" && this._input.peek(1) === ">"))
            ? ((g = this._input.next()), o === "/" && (g += this._input.next()), (h = this._create_token(l.TAG_CLOSE, g)))
            : c.text[0] === "{" &&
              o === "}" &&
              this._input.peek(1) === "}" &&
              (this._input.next(), this._input.next(), (h = this._create_token(l.TAG_CLOSE, "}}")))),
        h
      );
    }),
    (r.prototype._read_attribute = function (o, c, g) {
      ...
      if (g && g.text[0] === "<")
        if (o === "=") h = this._create_token(l.EQUALS, this._input.next());
          ...
          o === '"' ? (S += this.__patterns.double_quote.read()) : (S += this.__patterns.single_quote.read()),
            (h = this._create_token(l.VALUE, S));
        } else
          (m = this.__patterns.attribute.read()),
            m && (c.type === l.EQUALS ? (h = this._create_token(l.VALUE, m)) : (h = this._create_token(l.ATTRIBUTE, m)));
      return h;
    }),
    (r.prototype._is_content_unformatted = function (o) {
      return (
        this._options.void_elements.indexOf(o) === -1 &&
        (this._options.content_unformatted.indexOf(o) !== -1 || this._options.unformatted.indexOf(o) !== -1)
      );
    }),
    (r.prototype._read_raw_content = function (o, c, g) {
      var h = "";
      if (g && g.text[0] === "{") h = this.__patterns.handlebars_raw_close.read();
        ...
        } else this._is_content_unformatted(m) && (h = this._input.readUntil(new RegExp("</" + m + "[\\n\\r\\t ]*?>", "ig")));
      }
...
function Ss() {
  ...
  (u.prototype.current_line_has_match = function (d) {
    ...
    (u.prototype.print_preserved_newlines = function (d) {
      var _ = 0;
      d.type !== n.TEXT && d.previous.type !== n.TEXT && (_ = d.newlines ? 1 : 0),
        this.preserve_newlines && (_ = d.newlines < this.max_preserve_newlines + 1 ? d.newlines : this.max_preserve_newlines + 1);
      for (var b = 0; b < _; b++) this.print_newline(b > 0);
      return _ !== 0;
    }),
    (u.prototype.traverse_whitespace = function (d) {
      return d.whitespace_before || d.newlines
        ? (this.print_preserved_newlines(d) || (this._output.space_before_token = true), true)
        : false;
    }),
  ...
  var r = function (d) {
    ...
    o = function (d, _) {
      var b = null,
        A = null;
      return _.closed
        ? (d === "script" ? (b = "text/javascript") : d === "style" && (b = "text/css"),
          (b = r(_) || b),
          b.search("text/css") > -1
            ? (A = "css")
            : b.search(
...
`
    ...
    for (var v = null, f = p.next(); f.type !== n.EOF; )
      f.type === n.TAG_OPEN || f.type === n.COMMENT
        ...
        : f.type === n.ATTRIBUTE || f.type === n.EQUALS || f.type === n.VALUE || (f.type === n.TEXT && !x.tag_complete)
    ...
    (m.prototype._handle_control_flow_open = function (d, _) {
      ...
      return (
        d.set_space_before_token(_.newlines || _.whitespace_before !== "", true),
        _.newlines ? d.print_preserved_newlines(_) : d.set_space_before_token(_.newlines || _.whitespace_before !== "", true),
        d.print_token(_),
        d.indent(),
        b
      );
      ...
      return (
        ...
        b.is_unformatted
          ...
          : (b.tag_start_char === "<" &&
              ...
              this._is_wrap_attributes_force_expand_multiline && b.has_wrapped_attrs && d.print_newline(false)),
            d.print_token(_)),
        b.indent_content && !(b.is_unformatted || b.is_content_unformatted) && (d.indent(), (b.indent_content = false)),
        !b.is_inline_element && !(b.is_unformatted || b.is_content_unformatted) && d.set_wrap_point(),
        A
      );
    }),
        ...
        b.is_unformatted
          ...
          : b.tag_start_char === "{" && _.type === n.TEXT
            ...
            : (_.type === n.ATTRIBUTE
                ...
                : (_.type === n.EQUALS || (_.type === n.VALUE && _.previous.type === n.EQUALS)) &&
              ...
              _.type === n.ATTRIBUTE &&
                ...
                this._is_wrap_attributes_force &&
                  ...
                  (A.type !== n.TAG_OPEN || this._is_wrap_attributes_force_expand_multiline) &&
      ...
      if (_.text !== "") {
        ...
        b.custom_beautifier_name === "javascript" && typeof this._js_beautify == "function"
          ...
          this._options.indent_scripts === "keep"
            ? (p = 0)
            : this._options.indent_scripts === "separate" && (p = -d.indent_level);
...
` +
          ...
          x && ((_.text = x), (_.whitespace_before = ""), (_.newlines = 0), d.add_raw_token(_), d.print_newline(true));
      }
    }),
    (m.prototype._handle_tag_open = function (d, _, b, A, x) {
      var k = this._get_tag_open_token(_);
      if (
        ((b.is_unformatted || b.is_content_unformatted) && !b.is_empty_element && _.type === n.TAG_OPEN && !k.is_start_tag
          ? (d.add_raw_token(_), (k.start_tag_token = this._tag_stack.try_pop(k.tag_name)))
        ...
        var p = 0,
          v;
        do (v = x.peek(p)), v.type === n.ATTRIBUTE && (k.attr_count += 1), (p += 1);
      ...
      return (
        ...
        !k.tag_complete && !k.is_unformatted && (d.alignment_size = k.alignment_size),
        k
      );
    });
  var S = function (d, _) {
    if (
      ...
      (this.tag_start_char = _.text[0]),
        (this.text = _.text),
        this.tag_start_char === "<"
          ? ((b = _.text.match(/^<([^\s>]*)/)), (this.tag_check = b ? b[1] : ""))
          : ((b = _.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/)),
        ...
        (this.is_end_tag = !this.is_start_tag || (_.closed && _.closed.text === "/>"));
      var A = 2;
      this.tag_start_char === "{" && this.text.length >= 3 && this.text.charAt(2) === "~" && (A = 3),
        (this.is_end_tag =
          this.is_end_tag || (this.tag_start_char === "{" && (this.text.length < 3 || /[^#\^]/.test(this.text.charAt(A)))));
    }
  };
  (m.prototype._get_tag_open_token = function (d) {
    ...
    return (
      ...
      (_.is_end_tag = _.is_end_tag || c(_.tag_check, this._options.void_elements)),
      (_.is_empty_element = _.tag_complete || (_.is_start_tag && _.is_end_tag)),
      (_.is_unformatted = !_.tag_complete && c(_.tag_check, this._options.unformatted)),
      (_.is_content_unformatted = !_.is_empty_element && c(_.tag_check, this._options.content_unformatted)),
      (_.is_inline_element =
      ...
      if (
        (b.is_empty_element ||
          (b.is_end_tag
            ...
            : (this._do_optional_end_element(b) && (b.is_inline_element || d.print_newline(false)),
        ...
        c(b.tag_check, this._options.extra_liners) &&
          (d.print_newline(false), d._output.just_added_blankline() || d.print_newline(true)),
        b.is_empty_element)
      ) {
        ...
        (b.tag_name === "!--" &&
          ...
          b.text.indexOf(`
`) === -1) ||
          (b.is_inline_element || b.is_unformatted || d.print_newline(false), this._calcluate_parent_multiline(d, b));
    ...
    (m.prototype._calcluate_parent_multiline = function (d, _) {
      _.parent &&
        ...
        !((_.is_inline_element || _.is_unformatted) && _.parent.is_inline_element) &&
  ...
  return (
    (m.prototype._do_optional_end_element = function (d) {
      ...
      if (!(d.is_empty_element || !d.is_start_tag || !d.parent)) {
        if (d.tag_name === "body") _ = _ || this._tag_stack.try_pop("head");
        else if (d.tag_name === "li") _ = _ || this._tag_stack.try_pop("li", ["ol", "ul", "menu"]);
          ...
          d.tag_name === "rp" || d.tag_name === "rt"
            ...
            : d.tag_name === "optgroup"
              ...
              : d.tag_name === "option"
                ? (_ = _ || this._tag_stack.try_pop("option", ["select", "datalist", "optgroup"]))
                : d.tag_name === "colgroup"
                  ...
                  : d.tag_name === "thead"
                    ...
                    : d.tag_name === "tbody" || d.tag_name === "tfoot"
                      ...
                      : d.tag_name === "tr"
                        ? ((_ = _ || this._tag_stack.try_pop("caption", ["table"])),
                          (_ = _ || this._tag_stack.try_pop("colgroup", ["table"])),
                          (_ = _ || this._tag_stack.try_pop("tr", ["table", "thead", "tbody", "tfoot"])))
                        : (d.tag_name === "th" || d.tag_name === "td") &&
                          ((_ = _ || this._tag_stack.try_pop("td", ["table", "thead", "tbody", "tfoot", "tr"])),
                          (_ = _ || this._tag_stack.try_pop("th", ["table", "thead", "tbody", "tfoot", "tr"])));
...
`,
    ...
    l;
  return (
    typeof s == "number" && s !== 2 && (l = new RegExp("(\\r\\n|\\n|\\u2424) {" + s + ",}")),
...
function nr(e) {
  return [...(e.match(/from '([^']+)'(;)?(\r)?\n/g) || []), ...(e.match(/from "([^"]+)"(;)?(\r)?\n/g) || [])]
    .map(t => {
      let i = "";
      return (
        t.includes("'") ? (i = t.split("'")[1]) : t.includes('"') && (i = t.split('"')[1]),
        i.includes("/") && (i.startsWith("@") ? (i = i.split("/")[0] + "/" + i.split("/")[1]) : (i = i.split("/")[0])),
        i
      );
    })
    .filter(t => t !== "")
...
var rr = (e, { prefix: t }) => {
  ...
  if (e.includes(".")) {
    const i = e.split(".");
    return [`${t}${i.shift()}`, ...i.map((n, s) => `${n}${"_".repeat(s + 1)}`)].join(" ");
  }
  return `${t}${e}`;
};
var ar = class {
...
var Zt = class _Zt {
  ...
  static _walk(t, i) {
    return (
      typeof i == "string"
        ? t.addText(i)
        : i.children && (t.openNode(i), i.children.forEach(n => this._walk(t, n)), t.closeNode(i)),
      t
    );
  }
  static _collapse(t) {
    ...
    .map(n => {
      ...
      for (; l.length > 0; ) {
        ...
        (u += l.substring(0, r.index)),
          ...
          r[0][0] === "\\" && r[1] ? (u += "\\" + String(Number(r[1]) + s)) : ((u += r[0]), r[0] === "(" && i++);
      }
      return u;
    })
    .map(n => `(${n})`)
...
var Br = ["of", "and", "for", "in", "not", "or", "if", "then", "parent", "list", "value"];
var $r = "keyword";
function xn(e, t, i = $r) {
...
function Tn(e, t, { key: i }) {
  ...
  const s = e[i],
    l = {},
    u = {};
  for (let r = 1; r <= t.length; r++) (u[r + n] = s[r]), (l[r + n] = true), (n += bn(t[r - 1]));
...
function zr(e) {
  if (!!Array.isArray(e.begin)) {
    ...
    if (typeof e.beginScope != "object" || e.beginScope === null) throw (Ne("beginScope must be object"), ct);
    Tn(e, e.begin, { key: "beginScope" }), (e.begin = Jt(e.begin, { joinWith: "" }));
  }
}
function Fr(e) {
  if (!!Array.isArray(e.end)) {
    if (e.skip || e.excludeEnd || e.returnEnd) throw (Ne("skip, excludeEnd, returnEnd not compatible with endScope: {}"), ct);
    if (typeof e.endScope != "object" || e.endScope === null) throw (Ne("endScope must be object"), ct);
...
function Gr(e) {
  function t(u, r) {
    return new RegExp(He(u), "m" + (e.case_insensitive ? "i" : "") + (e.unicodeRegex ? "u" : "") + (r ? "g" : ""));
  }
  class i {
    constructor() {
  ...
  function l(u, r) {
    ...
    return (
      typeof u.keywords == "object" &&
        u.keywords.$pattern &&
        ((u.keywords = Object.assign({}, u.keywords)), (c = u.keywords.$pattern), delete u.keywords.$pattern),
      (c = c || /\w+/),
      ...
      r &&
        ...
        u.endsWithParent && r.terminatorEnd && (o.terminatorEnd += (u.end ? "|" : "") + r.terminatorEnd)),
...
var kn = function (e) {
  ...
  function c(y) {
    ...
    if (R) {
      const I = O(R[1]);
      return (
        I || (Fi(l.replace("{}", R[1])), Fi("Falling back to no-highlight mode for this block.", y)), I ? R[1] : "no-highlight"
      );
    }
...
https://github.com/highlightjs/highlight.js/issues/2277`
  ...
  function h(y, T, R, I) {
    ...
    function Y() {
      ...
      for (; D; ) {
        ...
        if (te) {
          const [me, Hn] = te;
          if ((ee.addText(U), (U = ""), ($[H] = ($[H] || 0) + 1), $[H] <= Vr && (Qe += Hn), me.startsWith("_"))) U += D[0];
          else {
    ...
    function wt(N, D) {
      return (
        N.scope && typeof N.scope == "string" && ee.openNode(re.classNameAliases[N.scope] || N.scope),
        N.beginScope &&
          (N.beginScope._wrap
            ? (J(q, re.classNameAliases[N.beginScope._wrap] || N.beginScope._wrap), (q = ""))
    ...
    function Ze(N) {
      ...
      for (const me of te) if (!!me && (me(N, H), H.isMatchIgnored)) return se(D);
      return (
        U.skip ? (q += D) : (U.excludeBegin && (q += D), X(), !U.returnBegin && !U.excludeBegin && (q = D)),
        wt(U, N),
    ...
    function Le(N) {
      ...
      B.endScope && B.endScope._wrap
        ...
        : B.endScope && B.endScope._multi
          ...
          : te.skip
            ? (q += D)
            : (te.returnEnd || te.excludeEnd || (q += D), X(), te.excludeEnd && (q = D));
      do B.scope && ee.closeNode(), !B.skip && !B.subLanguage && (Qe += B.relevance), (B = B.parent);
      while (B !== H.parent);
    ...
    function ze(N, D) {
      ...
      if (xt > 1e5 && xt > D.index * 3) throw new Error("potential infinite loop, way more iterations than matches");
      return (q += U), U.length;
    }
    const re = O(y);
    if (!re) throw (Ne(l.replace("{}", y)), new Error('Unknown language: "' + y + '"'));
    const Gn = Gr(re);
    let Et = "",
      B = I || Gn;
    const oi = {},
  ...
  function L(y) {
    ...
    const R = c(y);
    if (o(R)) return;
    if ((j("before:highlightElement", { el: y, language: R }), y.dataset.highlighted)) {
    ...
    if (
      ...
      throw new Xr("One of your code blocks includes unescaped HTML.", y.innerHTML);
    T = y;
  ...
  function p(y, T) {
    ...
    try {
      ...
      if ((Ne("Language definition for '{}' could not be registered.".replace("{}", y)), s)) Ne(I);
      else throw I;
      R = u;
    }
  ...
  function F(y) {
    return (
      Ie("10.7.0", "highlightBlock will be removed entirely in v12.0"), Ie("10.7.0", "Please use highlightElement now."), L(y)
    );
  }
  Object.assign(e, {
    highlight: g,
...
var Nn = ["Error", "EvalError", "InternalError", "RangeError", "ReferenceError", "SyntaxError", "TypeError", "URIError"];
var Cn = [
  "setInterval",
  "setTimeout",
  "clearInterval",
...
var Ln = ["arguments", "this", "super", "console", "window", "document", "localStorage", "sessionStorage", "module", "global"];
...
function Qr(e) {
  const t = e.regex,
    ...
    A = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, S, C, L, d, { match: /\$\d+/ }, h];
  m.contains = A.concat({
    begin: /\{/,
    end: /\}/,
    keywords: r,
  ...
  const M = {
      match: t.concat(/\b/, w([...Cn, "super", "import"].map(T => `${T}\\s*\\(`)), n, t.lookahead(/\s*\(/)),
    ...
    y = {
      match: [/const|var|let/, /\s+/, n, /\s*/, /=\s*/, /(async\s*)?/, t.lookahead(F)],
      keywords: "async",
      className: {
        1: "keyword",
        3: "title.function"
  ...
  return {
    ...
    contains: [
      ...
      },
      {
        ...
        returnBegin: true,
        label: "func.def",
        contains: [p, e.inherit(e.TITLE_MODE, { begin: n, className: "title.function" })]
      },
      {
        match: /\.\.\./,
        relevance: 0
...
var Dn = ["Error", "EvalError", "InternalError", "RangeError", "ReferenceError", "SyntaxError", "TypeError", "URIError"];
var Pn = [
  "setInterval",
  "setTimeout",
  "clearInterval",
...
var ta = ["arguments", "this", "super", "console", "window", "document", "localStorage", "sessionStorage", "module", "global"];
...
function na(e) {
  ...
  const M = {
      match: t.concat(/\b/, w([...Pn, "super", "import"].map(T => `${T}\\s*\\(`)), n, t.lookahead(/\s*\(/)),
      className: "title.function",
      relevance: 0
    },
    P = {
  ...
  return {
    ...
    contains: [
      ...
      i.ATTRIBUTE_SELECTOR_MODE,
      {
        ...
        variants: [{ begin: ":(" + ua.join("|") + ")" }, { begin: ":(:)?(" + _a.join("|") + ")" }]
      },
      i.CSS_VARIABLE,
      {
        className: "attribute",
    ...
    e === W.VUE
      ? ((i.dependencies.vue = "latest"),
        t === ye.STACKBLITZ
          ...
          : t === ye.CODESANDBOX && (i.devDependencies["@vue/cli-plugin-babel"] = "latest"))
      : e === W.REACT &&
        ...
        t === ye.STACKBLITZ && ((i.devDependencies.vite = "latest"), (i.devDependencies["@vitejs/plugin-react"] = "latest"))),
    i
  );
};
function vt(e) {
...
function va(e) {
  var s, l, u;
  const t = (s = (e.templates || []).find(r => r.scope === "global")) == null ? void 0 : s.files,
    i = (l = (e.templates || []).find(r => r.scope === e.type)) == null ? void 0 : l.files,
    n = (u = (e.templates || []).find(r => r.scope === e.scope)) == null ? void 0 : u.files;
  e.customFiles = {
    ...t,
    ...i,
    ...n
...
var qi = ["angular-cli", "create-react-app", "html", "javascript", "node", "polymer", "typescript", "vue"];
...
function Ma(e, t, i = {}) {
  ...
  i.crossOriginIsolated && !n.includes("cross-origin-isolated") && n.push("cross-origin-isolated"),
...
var Ia = class {
  ...
  messageListener(t) {
    var r;
    if (typeof ((r = t.data.payload) == null ? void 0 : r.__reqid) != "string") return;
    const { type: i, payload: n } = t.data,
      { __reqid: s, __success: l, __error: u } = n;
    this.pending[s] &&
      (l ? this.pending[s].resolve(this.cleanResult(n)) : this.pending[s].reject(u ? `${i}: ${u}` : i), delete this.pending[s]);
  }
  cleanResult(t) {
    const i = { ...t };
...
var Da = class {
  ...
  applyFsDiff(t) {
    ...
    if (!i(t) || !i(t.create)) throw new Error("Invalid diff object: expected diff.create to be an object.");
    if (!Array.isArray(t.destroy)) throw new Error("Invalid diff object: expected diff.destroy to be an array.");
    return this._rdc.request({
    ...
    (this.id = $n()),
      ...
      (this.pending = new Promise((i, n) => {
        ...
        const o = window.setInterval(() => {
          ...
          if (r >= Oa) {
            u(),
              n("Timeout: Unable to establish a connection with the StackBlitz VM"),
              lt.forEach((c, g) => {
...
function jn({ template: e, title: t, description: i, dependencies: n, files: s, settings: l }) {
  if (!qi.includes(e)) {
              ...
              s.value
                ? (openBlock(),
                  createElementBlock(
                    ...
                    [createVNode(_o), createBaseVNode("span", co, toDisplayString(c.content), 1)],
                    6
                  ))
      ...
      createElementBlock(
        ...
        [
          createBaseVNode(
            ...
            [renderSlot(n.$slots, "content", {}, () => [createTextVNode(toDisplayString(i.content), 1)], true)],
            2
          ),
...
var Qo = defineComponent({
  ...
  setup(e) {
    ...
    const h = ei(),
      ...
      d = computed(() => (l.value && l.value[s.value] ? Hi(l.value[s.value]) : Hi(L.value))),
      _ = computed(() =>
        [W.VUE, W.REACT, W.HTML].filter(y => t[`${y}Code`]).sort((y, T) => u.value.indexOf(y) - u.value.indexOf(T))
      );
    watch(
    ...
    function v() {
      nextTick(() => {
        ...
        const R = document.head.querySelectorAll("style"),
          ...
          G = Array.from(R).map(J => `<style replace="true">${J.innerText}</style>`).join(`
`),
        ...
        const X = (p = function () {
          requestAnimationFrame(() => {
            (y.style.height = T.body.scrollHeight + "px"),
              T.documentElement && (T.documentElement.className = document.documentElement.className),
              X === p && p();
          });
        });
        p();
    ...
    function a() {
      nextTick(() => {
        t.reactComponent &&
          c.value === "react" &&
          t.reactCode &&
          (O || (O = t.reactCreateRoot(f.value)), O.render(t.reactCreateElement(t.reactComponent, {}, null)));
      });
    }
    onUnmounted(() => {
      O && (O.unmount(), (O = null));
                ...
                createBaseVNode(
                  ...
                  [
                    ...
                    y.github
                      ? (openBlock(),
                        createBlock(
                          ...
                          {
                            default: withCtx(() => [createVNode(io, { onClick: b })]),
                            _: 1
                          }
                        ))
                      : createCommentVNode("", true),
                    y.gitlab
                      ? (openBlock(),
                        createBlock(
                          ...
                          {
                            default: withCtx(() => [createVNode(ao, { onClick: A })]),
                            _: 1
                          }
                        ))
                      : createCommentVNode("", true),
                    ...
                    createVNode(
                      ...
                      { content: "复制代码" },
                      {
                        default: withCtx(() => [createVNode(cs, { onClick: x })]),
                        _: 1
                      }
                    )
                  ],
                ...
                createBaseVNode(
                  ...
                  [
                    Object.keys(l.value).length
                              ...
                              renderList(
                                ...
                                R => (
                                  ...
                                  createElementBlock(
                                    ...
                                    {
                                      key: R,
                                      class: normalizeClass([unref(h).bem("tab"), s.value === R && unref(h).bem("active-tab")]),
                                      onClick: I => E(R)
                                    },
                                    toDisplayString(R),
                                    11,
                      ...
                      : createCommentVNode("", true),
                    createBaseVNode("pre", wo, [createBaseVNode("code", { innerHTML: d.value }, null, 8, Eo)])
                  ],
                  512
                )
              ],
            ...
            unref(m)
              ...
              : (openBlock(),
                createElementBlock(
                  ...
                  [createVNode(ds), T[4] || (T[4] = createTextVNode("收起代码 "))],
                  2
                ))
          ],
          2
...
var oe = (e, t, i, n) => {
  ...
  if (
    ...
    const o = s[0];
    if (o.content.includes(t) && (!i || o.content.includes(u))) s[0].content = o.content;
    else {
...
function Fn(e) {
  ...
  if ((ce === Kt || !ce) && setTimeout) return (ce = setTimeout), setTimeout(e, 0);
  try {
    return ce(e, 0);
  } catch {
    try {
...
function Ao(e) {
  ...
  if ((pe === Gt || !pe) && clearTimeout) return (pe = clearTimeout), clearTimeout(e);
  try {
    return pe(e);
  } catch {
    try {
  ...
  for (var i = "", n = 0, s = -1, l = 0, u, r = 0; r <= e.length; ++r) {
    ...
    if (u === 47) {
      if (!(s === r - 1 || l === 1))
        ...
        } else i.length > 0 ? (i += "/" + e.slice(s + 1, r)) : (i = e.slice(s + 1, r)), (n = r - s - 1);
      (s = r), (l = 0);
    } else u === 46 && l !== -1 ? ++l : (l = -1);
  }
  return i;
...
var Pe = {
  ...
  relative: function (t, i) {
    if ((le(t), le(i), t === i || ((t = Pe.resolve(t)), (i = Pe.resolve(i)), t === i))) return "";
    ...
    for (var r = i.length, o = r - u, c = l < o ? l : o, g = -1, h = 0; h <= c; ++h) {
      if (h === c) {
        ...
        } else l > c && (t.charCodeAt(n + h) === 47 ? (g = h) : h === 0 && (g = 0));
        break;
      }
    ...
    var C = "";
    for (h = n + g + 1; h <= s; ++h) (h === s || t.charCodeAt(h) === 47) && (C.length === 0 ? (C += "..") : (C += "/.."));
  ...
  parse: function (t) {
    ...
    return (
      u === -1 || o === -1 || h === 0 || (h === 1 && u === o - 1 && u === r + 1)
        ? o !== -1 && (r === 0 && s ? (i.base = i.name = t.slice(1, o)) : (i.base = i.name = t.slice(r, o)))
        : (r === 0 && s
...
var Ji = (e, t, i, n) => {
  ...
  let { order: c = "vue,react,html", visible: g = true, select: h = (l.order || "vue,react,html").split(",")[0] || "vue" } = l;
  const m = {
      vue: "",
      title: "",
      description: "",
  ...
  x != null && x[1] && (P = x[1]),
    ...
    (m.title = S ? S[1] : ""),
    (m.description = _ ? _[1] : "");
  const F = m.vue ? ne.resolve(s || ne.dirname(i.path), (C == null ? void 0 : C[1]) || ".").replace(/\\/g, "/") : "",
    y = m.html ? ne.resolve(s || ne.dirname(i.path), (L == null ? void 0 : L[1]) || ".").replace(/\\/g, "/") : "",
    T = m.react ? ne.resolve(s || ne.dirname(i.path), (d == null ? void 0 : d[1]) || ".").replace(/\\/g, "/") : "",
...
var Jo = (e, t) => {
  ...
  (e.renderer.rules.html_inline = (s, l, u, r, o) => {
    const c = s[l];
    return (
      (c.content = c.content.replace(/<!--[\s\S]*?-->/g, "")), Zi.some(g => g.test(c.content)) ? Ji(e, c, r, t) : i(s, l, u, r, o)
    );
  }),
