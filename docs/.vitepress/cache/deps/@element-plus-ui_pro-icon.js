import { ElIcon, iconProps } from "./chunk-CI5Z5LG7.js";
import {
...
import { computed, createVNode, defineComponent, mergeProps } from "./chunk-FNEGEEL4.js";
...
var e = defineComponent(
  (n, r) => {
    ...
    return () =>
      createVNode(ElIcon, n, {
        default: () => {
          var o, l;
          return [
            ((l = (o = r.slots) == null ? void 0 : o.default) == null ? void 0 : l.call(o)) ||
              (m2.value && createVNode(m2.value, null, null))
          ];
        }
      });
  },
...
//# sourceMappingURL=@element-plus-ui_pro-icon.js.map
