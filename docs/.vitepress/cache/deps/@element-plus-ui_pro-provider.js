...
import { defineComponent, provide } from "./chunk-FNEGEEL4.js";
...
var f = (c, o) => {
  if (
    ((c.install = s => {
      for (const n of [c, ...Object.values(o != null ? o : {})]) s.component(n.name, n);
    }),
    o)
  )
    for (const [s, n] of Object.entries(o)) c[s] = n;
  return c;
};
...
var u = defineComponent({
  ...
  setup(t, a) {
    if (t.value && Object.keys(t.value).length) {
      ...
      for (const e in t.value) Object.prototype.hasOwnProperty.call(t.value, e) && provide(e, t.value[e]);
    }
    return () => {
      var e, l;
...
var d = f(u);
export { u as ProProvider, d as default };
