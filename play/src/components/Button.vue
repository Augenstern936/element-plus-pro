 ...
 * @LastEditTime: 2024-08-25 15:36:08
-->
<template>
  <el-card>
    <el-space>
      ...
      <pro-button type="danger" :tip="{ mode: 'message-box', title: '温馨提示', message: '确定要删除吗?' }"> 删除 </pro-button>
      <pro-button type="danger" :tip="{ mode: 'popconfirm', title: '确定要删除吗?' }"> 删除 </pro-button>
    </el-space>
  </el-card>
</template>
