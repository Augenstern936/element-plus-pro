import { inject as Nt, h as Ir, defineComponent as Dt, ref as W, computed as ie, createVNode as i, watch as it, createTextVNode as dt, isVNode as Nr, Fragment as ut, provide as Qt, withDirectives as Dr, vShow as Br, KeepAlive as zr } from "vue";
import { withInstall as $r, toOptions as Lr } from "@element-plus/pro-utils";
import { ElInput as Ur, ElButton as ye, ElTooltip as De, ElPopover as Vr, ElCheckbox as Yt, ElCheckboxGroup as Mr, ElTableColumn as _r, ElSpace as qr, ElIcon as xt, ElProgress as Hr, ElRate as Kr, ElAvatar as Gr, ElImage as Wr, ElAlert as Qr, ElMessage as Yr, ElTable as Zr, ElPagination as Jr } from "element-plus";
import Xr from "@element-plus/pro-search-bar";
import { RefreshRight as ea, Search as Rt, Setting as ta, FullScreen as ra, DocumentCopy as aa, UserFilled as na, Picture as sa, View as la, Edit as ca, Delete as oa } from "@element-plus/icons-vue";
import ia from "@element-plus/pro-button";
const ua = {
  loading: {
    type: Boolean,
    default: !1
...
var st = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".split(""), fa = function e(t) {
...
function pa(e, t) {
  return ga(e) || ba(e, t) || or(e, t) || Sa();
}
function ft(e) {
  return va(e) || ma(e) || or(e) || ya();
}
function va(e) {
  if (Array.isArray(e))
    return Ft(e);
...
function ba(e, t) {
  if (!(typeof Symbol == "undefined" || !(Symbol.iterator in Object(e)))) {
    ...
    try {
      for (var g = e[Symbol.iterator](), C; !(n = (C = g.next()).done) && (a.push(C.value), !(t && a.length === t)); n = !0)
        ;
    } catch (T) {
      s = !0, m = T;
    } finally {
...
var ka = Function.prototype, ir = Object.prototype, ur = ka.toString, Ea = ir.hasOwnProperty, ja = ur.call(Object), Oa = ir.toString, xa = Aa(Object.getPrototypeOf, Object);
function Pa(e) {
  return !!e && typeof e == "object";
}
function Ta(e) {
  if (!Pa(e) || Oa.call(e) != Ca || wa(e))
    return !1;
  var t = xa(e);
  if (t === null)
    return !0;
  var a = Ea.call(t, "constructor") && t.constructor;
  return typeof a == "function" && a instanceof a && ur.call(a) == ja;
}
var fr = Ta, Ra = /([A-Z])/g, Fa = /^ms-/;
function Ia(e) {
  return e.replace(Ra, "-$1").toLowerCase();
}
function Na(e) {
  return Ia(e).replace(Fa, "-ms-");
}
var Da = Na, Ba = function e(t, a) {
  var n = Object.keys(t).map(function(s) {
    return fr(t[s]) ? e(t[s], s) : "".concat(Da(s), ": ").concat(t[s], ";");
  }).join(" ");
  return a ? "".concat(a, ` {
  `).concat(n, `
}`) : n;
  ...
  return t.reduce(function(n, s) {
    return s == null || s === !1 || s === "" ? n : Array.isArray(s) ? [].concat(ft(n), ft(e(s, a))) : typeof s == "function" ? a ? n.concat.apply(n, ft(e([s(a)], a))) : n.concat(s) : n.concat(fr(s) ? Ba(s) : s.toString());
  }, []);
}, dr = function(e) {
...
}("development"), hr = !1, Ne = typeof document != "undefined" && !hr, za = function() {
  if (Ne) {
...
var tr = function() {
  function e() {
    var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, a = t.speedy, n = a === void 0 ? !Xt && !hr : a, s = t.maxLength, m = s === void 0 ? Ne && za ? 4e3 : 65e3 : s;
    ...
    value: function(a) {
      ...
      if (Ne)
        if (this.isSpeedy && this.sheet.insertRule)
          ...
          Pt(this.tags).appendChild(s), n = {
            textNode: s,
            appendRule: function(g) {
              return s.appendData(g);
            }
          }, this.isSpeedy || (this.sheet = ct(Pt(this.tags)));
        }
      else
        n = this.sheet.insertRule(a);
      return this.ctr++, Ne && this.ctr % this.maxLength === 0 && (this.tags.push(er()), this.sheet = ct(Pt(this.tags))), n;
    }
  }, {
    key: "flush",
    value: function() {
...
var Ua = pr(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  }), t.default = a;
  function a(g, C) {
    for (var T = 1540483477, U = 24, u = C ^ g.length, x = g.length, E = 0; x >= 4; ) {
      var p = n(g, E);
      p = m(p, T), p ^= p >>> U, p = m(p, T), u = m(u, T), u ^= p, E += 4, x -= 4;
    }
    switch (x) {
      case 3:
        u ^= s(g, E), u ^= g.charCodeAt(E + 2) << 16, u = m(u, T);
        break;
      case 2:
        u ^= s(g, E), u = m(u, T);
        break;
      case 1:
        u ^= g.charCodeAt(E), u = m(u, T);
        break;
    }
    return u ^= u >>> 13, u = m(u, T), u ^= u >>> 15, u >>> 0;
  }
  function n(g, C) {
    return g.charCodeAt(C++) + (g.charCodeAt(C++) << 8) + (g.charCodeAt(C++) << 16) + (g.charCodeAt(C) << 24);
  }
  function s(g, C) {
    return g.charCodeAt(C++) + (g.charCodeAt(C++) << 8);
  }
  function m(g, C) {
    g = g | 0, C = C | 0;
    var T = g & 65535, U = g >>> 16, u = T * C + ((U * C & 65535) << 16) | 0;
    return u;
  }
}), Va = La(Ua), It = pr(function(e, t) {
  (function(a) {
    e.exports = a(null);
  })(
    /** @param {*=} options */
    function a(n) {
      var s = /^\0+/g, m = /[\0\r\f]/g, g = /: */g, C = /zoo|gra/, T = /([,: ])(transform)/g, U = /,+\s*(?![^(]*[)])/g, u = / +\s*(?![^(]*[)])/g, x = / *[\0] */g, E = /,\r+?/g, p = /([\t\r\n ])*\f?&/g, b = /:global\(((?:[^\(\)\[\]]*|\[.*\]|\([^\(\)]*\))*)\)/g, P = /\W+/g, B = /@(k\w+)\s*(\S*)\s*/, z = /::(place)/g, q = /:(read-only)/g, F = /\s+(?=[{\];=:>])/g, G = /([[}=:>])\s+/g, Q = /(\{[^{]+?);(?=\})/g, ae = /\s{2,}/g, Y = /([^\(])(:+) */g, V = /[svh]\w+-[tblr]{2}/, Z = /\(\s*(.*)\s*\)/g, Ce = /([\s\S]*?);/g, pe = /-self|flex-/g, Ke = /[^]*?(:[rp][el]a[\w-]+)[^]*/, vt = /stretch|:\s*\w+\-(?:conte|avail)/, Be = /([^-])(image-set\()/, j = "-webkit-", we = "-moz-", H = "-ms-", J = 59, Ae = 125, ke = 123, ve = 40, Ee = 41, ze = 91, gt = 93, ne = 10, je = 13, se = 9, Re = 64, l = 32, w = 38, A = 45, X = 95, ee = 42, ue = 44, le = 58, Ge = 39, We = 34, ce = 47, Qe = 62, Ye = 43, Ze = 126, Je = 0, $t = 12, br = 11, Xe = 107, mt = 109, Lt = 115, Ut = 112, Vt = 111, yr = 105, Sr = 99, Mt = 100, Cr = 112, fe = 1, Oe = 1, xe = 0, de = 1, oe = 1, bt = 1, _t = 0, qt = 0, yt = 0, St = [], Ct = [], ge = 0, wt = null, wr = -2, Ar = -1, kr = 0, Er = 1, jr = 2, Or = 3, Ht = 0, Ve = 1, et = "", Pe = "", Me = "";
      function At(d, h, f, S, o) {
        for (var r = 0, v = 0, c = 0, O = 0, I = 0, $ = 0, k = 0, K = 0, rt = 0, Wt = 0, Fe = 0, me = 0, at = 0, he = 0, R = 0, re = 0, Le = 0, qe = 0, N = 0, Ie = f.length, He = Ie - 1, M = "", y = "", D = "", L = "", nt = "", Ot = "", be, Te; R < Ie; ) {
          if (k = f.charCodeAt(R), R === He && v + O + c + r !== 0 && (v !== 0 && (k = v === ce ? ne : ce), O = c = r = 0, Ie++, He++), v + O + c + r === 0) {
            ...
            if (Le === 1)
              switch (k) {
                ...
                case l:
                  break;
                default:
                  for (Le = 0, N = R, I = k, R--, k = J; N < Ie; )
                    switch (f.charCodeAt(N++)) {
                      case ne:
                      case je:
                      case J: {
                        ++R, k = I, N = Ie;
            ...
            switch (k) {
              case ke: {
                for (y = y.trim(), I = y.charCodeAt(0), Fe = 1, N = ++R; R < Ie; ) {
                  switch (k = f.charCodeAt(R)) {
                    case ke: {
                      Fe++;
                      break;
                    }
                ...
                switch (D = f.substring(N, R), I === Je && (I = (y = y.replace(s, "").trim()).charCodeAt(0)), I) {
                  case Re: {
                    ...
                    if (D = At(h, be, D, $, o + 1), N = D.length, yt > 0 && N === 0 && (N = y.length), ge > 0 && (be = Kt(St, y, qe), Te = $e(Or, D, be, h, Oe, fe, N, $, o, S), y = be.join(""), Te !== void 0 && (N = (D = Te.trim()).length) === 0 && ($ = 0, D = "")), N > 0)
                      switch ($) {
                        case Lt:
                          y = y.replace(Z, xr);
                        case Mt:
                        ...
                        case Xe: {
                          y = y.replace(B, "$1 $2" + (Ve > 0 ? et : "")), D = y + "{" + D + "}", oe === 1 || oe === 2 && tt("@" + D, 3) ? D = "@" + j + D + "@" + D : D = "@" + D;
                          break;
                        }
                        default:
                          D = y + D, S === Cr && (D = (L += D, ""));
                  ...
                  default:
                    D = At(h, Kt(h, y, qe), D, S, o + 1);
                }
                nt += D, me = 0, Le = 0, he = 0, re = 0, qe = 0, at = 0, y = "", D = "", k = f.charCodeAt(++R);
                break;
              }
              case Ae:
              case J: {
                if (y = (re > 0 ? y.replace(m, "") : y).trim(), (N = y.length) > 1)
                  switch (he === 0 && (I = y.charCodeAt(0), (I === A || I > 96 && I < 123) && (N = (y = y.replace(" ", ":")).length)), ge > 0 && (Te = $e(Er, y, h, d, Oe, fe, L.length, S, o, S)) !== void 0 && (N = (y = Te.trim()).length) === 0 && (y = "\0\0"), I = y.charCodeAt(0), $ = y.charCodeAt(1), I) {
                    case Je:
                      break;
                    case Re:
                      if ($ === yr || $ === Sr) {
                    ...
                    default: {
                      if (y.charCodeAt(N - 1) === le)
                        break;
                      L += kt(y, I, $, y.charCodeAt(2));
                    }
                  }
                me = 0, Le = 0, he = 0, re = 0, qe = 0, y = "", k = f.charCodeAt(++R);
                break;
              }
            }
          }
          switch (k) {
            ...
            case ne: {
              ...
              v === ce ? v = 0 : de + me === 0 && S !== Xe && y.length > 0 && (re = 1, y += "\0"), ge * Ht > 0 && $e(kr, y, h, d, Oe, fe, L.length, S, o, S), fe = 1, Oe++;
              break;
            }
            case J:
            case Ae:
              ...
              switch (fe++, M = f.charAt(R), k) {
                ...
                case ce: {
                  ...
                  switch (v) {
                    ...
                    case ee:
                      k === ce && K === ee && N + 2 !== R && (f.charCodeAt(N + 2) === 33 && (L += f.substring(N, R + 1)), M = "", v = 0);
                  }
                }
              }
              if (v === 0) {
        ...
        if (N = L.length, yt > 0 && N === 0 && nt.length === 0 && h[0].length !== 0 && (S !== mt || h.length === 1 && (de > 0 ? Pe : Me) === h[0]) && (N = h.join(",").length + 2), N > 0) {
          if (be = de === 0 && S !== Xe ? Tr(h) : h, ge > 0 && (Te = $e(jr, L, be, d, Oe, fe, N, S, o, S), Te !== void 0 && (L = Te).length === 0))
            return Ot + L + nt;
          if (L = be.join(",") + "{" + L + "}", oe * xe !== 0) {
            switch (oe === 2 && !tt(L, 2) && (xe = 0), xe) {
              case Vt: {
      ...
      function Kt(d, h, f) {
        var S = h.trim().split(E), o = S, r = S.length, v = d.length;
        switch (v) {
          case 0:
          case 1: {
            for (var c = 0, O = v === 0 ? "" : d[0] + " "; c < r; ++c)
              o[c] = Gt(O, o[c], f, v).trim();
            break;
          }
          default:
            for (var c = 0, I = 0, o = []; c < r; ++c)
              for (var $ = 0; $ < v; ++$)
                o[I++] = Gt(d[$] + " ", S[c], f, v).trim();
        }
        return o;
      }
      function Gt(d, h, f, S) {
        ...
        switch (r < 33 && (r = (o = o.trim()).charCodeAt(0)), r) {
          ...
          case le:
            switch (o.charCodeAt(1)) {
              case 103: {
                if (bt > 0 && de > 0)
                  return o.replace(b, "$1").replace(p, "$1" + Me);
                break;
              }
              default:
                return d.trim() + o.replace(p, "$1" + d.trim());
            }
          default:
            if (f * de > 0 && o.indexOf("\f") > 0)
              return o.replace(p, (d.charCodeAt(0) === le ? "" : "$1") + d.trim());
        }
        return d + o;
      }
      function kt(d, h, f, S) {
        var o = 0, r = d + ";", v = h * 2 + f * 3 + S * 4, c;
        if (v === 944)
          return Pr(r);
        if (oe === 0 || oe === 2 && !tt(r, 1))
          return r;
        switch (v) {
          ...
          case 1005:
            return C.test(r) ? r.replace(g, ":" + j) + r.replace(g, ":" + we) + r : r;
          case 1e3: {
          ...
          case 1017:
            if (r.indexOf("sticky", 9) === -1)
              return r;
          case 975: {
            switch (o = (r = d).length - 10, c = (r.charCodeAt(o) === 33 ? r.substring(0, o) : r).substring(d.indexOf(":", 7) + 1).trim(), v = c.charCodeAt(0) + (c.charCodeAt(7) | 0)) {
              case 203:
              ...
              case 207:
              case 102:
                r = r.replace(c, j + (v > 102 ? "inline-" : "") + "box") + ";" + r.replace(c, j + c) + ";" + r.replace(c, H + c + "box") + ";" + r;
            }
            return r + ";";
          }
          case 938: {
          ...
          case 953: {
            if (vt.test(d) === !0)
              return (c = d.substring(d.indexOf(":") + 1)).charCodeAt(0) === 115 ? kt(d.replace("stretch", "fill-available"), h, f, S).replace(":fill-available", ":stretch") : r.replace(c, j + c) + r.replace(c, we + c.replace("fill-", "")) + r;
            break;
          }
          case 962: {
            if (r = j + r + (r.charCodeAt(5) === 102 ? H + r : "") + r, f + S === 211 && r.charCodeAt(13) === 105 && r.indexOf("transform", 10) > 0)
      ...
      function tt(d, h) {
        var f = d.indexOf(h === 1 ? ":" : "{"), S = d.substring(0, h !== 3 ? f : 10), o = d.substring(f + 1, d.length - 1);
        return wt(h !== 2 ? S : S.replace(Ke, "$1"), o, h);
      }
      function xr(d, h) {
        var f = kt(h, h.charCodeAt(0), h.charCodeAt(1), h.charCodeAt(2));
        return f !== h + ";" ? f.replace(Ce, " or ($1)").substring(4) : "(" + h + ")";
      }
      function Pr(d) {
        var h = d.length, f = d.indexOf(":", 9) + 1, S = d.substring(0, f).trim(), o = d.substring(f, h - 1).trim();
        switch (d.charCodeAt(9) * Ve) {
          ...
          case A:
            if (d.charCodeAt(10) !== 110)
              break;
          default:
            for (var r = o.split((o = "", U)), v = 0, f = 0, h = r.length; v < h; f = 0, ++v) {
              for (var c = r[v], O = c.split(u); c = O[f]; ) {
                var I = c.charCodeAt(0);
                if (Ve === 1 && // letters
                (I > Re && I < 90 || I > 96 && I < 123 || I === X || // dash but not in sequence i.e --
                I === A && c.charCodeAt(1) !== A))
        ...
        return o = S + o + ";", oe === 1 || oe === 2 && tt(o, 1) ? j + o + o : o;
      }
      function Tr(d) {
        for (var h = 0, f = d.length, S = Array(f), o, r; h < f; ++h) {
          for (var v = d[h].split(x), c = "", O = 0, I = 0, $ = 0, k = 0, K = v.length; O < K; ++O)
            if (!((I = (r = v[O]).length) === 0 && K > 1)) {
              ...
              switch (k) {
                ...
                case le: {
                  switch (r.charCodeAt(1) * 2 + r.charCodeAt(2) * 3) {
                    case 530:
                      if (bt > 0) {
                        r = o + r.substring(8, I - 1);
                        break;
                      }
                    default:
                      (O < 1 || v[O - 1].length < 1) && (r = o + Pe + r);
                  }
                  break;
                }
                case ue:
                  o = "";
                default:
                  I > 1 && r.indexOf(":") > 0 ? r = o + r.replace(Y, "$1" + Pe + "$2") : r = o + r + Pe;
              }
              c += r;
            }
      ...
      function $e(d, h, f, S, o, r, v, c, O, I) {
        for (var $ = 0, k = h, K; $ < ge; ++$)
          switch (K = Ct[$].call(_e, d, k, f, S, o, r, v, c, O, I)) {
            case void 0:
            case !1:
            case !0:
            case null:
      ...
      function Rr(d, h, f, S) {
        for (var o = h + 1; o < f; ++o)
          switch (S.charCodeAt(o)) {
            case ce: {
              if (d === ee && S.charCodeAt(o - 1) === ee && h + 2 !== o)
                return o + 1;
              break;
            }
            case ne:
      ...
      function Fr(d) {
        return d.replace(m, "").replace(F, "").replace(G, "$1").replace(Q, "$1").replace(ae, " ");
      }
      function Et(d) {
        switch (d) {
          case void 0:
        ...
        for (var h in d) {
          ...
          switch (h) {
            ...
            case "preserve":
              ...
              break;
            case "prefix":
              wt = null, f ? typeof f != "function" ? oe = 1 : (oe = 2, wt = f) : oe = 0;
          }
        }
        return jt;
      }
      function _e(d, h) {
        if (this !== void 0 && this.constructor === _e)
          return a(d);
        var f = d, S = f.charCodeAt(0);
        S < 33 && (S = (f = f.trim()).charCodeAt(0)), Ve > 0 && (et = f.replace(P, S === ze ? "" : "-")), S = 1, de === 1 ? Me = f : Pe = f;
        var o = [Me], r;
        ge > 0 && (r = $e(Ar, h, o, o, Oe, fe, 0, 0, 0, 0), r !== void 0 && typeof r == "string" && (h = r));
        var v = At(St, o, h, 0, 0);
        return ge > 0 && (r = $e(wr, v, o, o, Oe, fe, v.length, 0, 0, 0), r !== void 0 && typeof (v = r) != "string" && (S = 0)), et = "", Me = "", Pe = "", xe = 0, Oe = 1, fe = 1, _t * S === 0 ? v : Fr(v);
      }
...
(function() {
  ...
  return pt(e, [{
    ...
    value: function() {
      ...
      var a = Bt(this.rules).join(""), n = this.selector ? "".concat(this.selector, " { ").concat(a, " }") : a, s = It("", n, !1, !1);
      Ue.insert(s, {
        global: !0
      });
    }
...
var Ma = Object.prototype, _a = Ma.hasOwnProperty;
function qa(e, t, a) {
  var n = e[t];
  (!(_a.call(e, t) && Ga(n, a)) || a === void 0 && !(t in e)) && (e[t] = a);
}
function Ha(e, t, a) {
  for (var n = -1, s = e.length, m = t.length, g = {}; ++n < s; ) {
...
function rr() {
  ...
  return Array.isArray(e) ? Wa(e) : e;
}
var Qa = ["value", "name", "type", "id", "href"], Ya = function(e) {
  var t = function a(n, s, m) {
    var g = new e(s), C = rr(n.props), T = rr(m), U = n.props ? Object.keys(C) : Qa, u = n.props ? lt({}, T, {}, C) : T;
    return {
      props: lt({
        as: [String, Object],
        modelValue: null
      ...
      setup: function(E, p) {
        var b = p.slots, P = p.attrs, B = p.emit, z = Nt("theme");
        return function() {
          var q = g.generateAndInjectStyles(lt({
            theme: z
          }, E, {}, P)), F = [q];
          P.class && F.push(P.class);
          var G = {};
          if (U.length)
            for (var Q = 0, ae = Object.entries(E); Q < ae.length; Q++) {
              var Y = pa(ae[Q], 2), V = Y[0], Z = Y[1];
              U.includes(V) && (G[V] = Z);
            }
      ...
      extend: function(E) {
        for (var p = arguments.length, b = new Array(p > 1 ? p - 1 : 0), P = 1; P < p; P++)
          b[P - 1] = arguments[P];
  ...
  var t = {}, a = function() {
    ...
    return pt(n, [{
      ...
      value: function(m) {
        var g = Bt(this.rules, m).join("").replace(/^\s*\/\/.*$/gm, ""), C = Va(g);
        if (!t[C]) {
          var T = e(C);
          t[C] = T;
          var U = It(".".concat(T), g);
...
var tn = function(e) {
  var t = function(n) {
    ...
    return function(m) {
      for (var g = arguments.length, C = new Array(g > 1 ? g - 1 : 0), T = 1; T < g; T++)
        C[T - 1] = arguments[T];
...
const an = rn, nn = an("div", { ghost: Boolean })`
	border-radius: 3px;
...
let te = {
  ...
  toggle(e, t) {
    return te.isFullscreen ? te.exit() : te.request(e, t);
  },
  onchange(e) {
    te.on("change", e);
  },
...
const sn = /* @__PURE__ */ Dt((e, t) => {
  const a = Nt("toolbar", {}), n = W(!1), s = W(""), m = W(!0), g = W([]), C = ie(() => {
    var P, B;
    const b = (B = (P = t.slots) == null ? void 0 : P.title) == null ? void 0 : B.call(P);
    return b[0].children ? b : a.title ? i("h3", null, [a.title]) : "";
  }), T = ie(() => {
    var Y;
    ...
    return typeof b == "object" && b != null ? b != null && b.__v_isVNode ? b : Array.isArray(b) && b.length ? b.map((z) => z.__v_isVNode ? z : i(ye, z, {
      default: () => [z.content]
    })) : i(ye, b, {
      default: () => [b.content]
    }) : (B = (P = t.slots).actions) == null ? void 0 : B.call(P);
  }), u = ie(() => a.columns.filter(({
    title: b
  }) => b)), x = (b) => {
    t.emit("columnsSettingChange", b);
  }, E = () => {
    m.value = !0, g.value = u.value.map(({
      id: b
    }) => b), t.emit("columnsSettingReset");
  }, p = () => {
    if (Tt.isEnabled) {
      const b = document.getElementById("pro-table");
      n.value ? Tt.exit() : Tt.request(b), n.value = !n.value, t.emit("fullScreenChange", n.value);
    }
  };
  return it(() => m.value, (b) => {
    if (b)
      return E();
    g.value = [], t.emit("columnsSettingChange", []);
  }, {
    immediate: !0
  }), () => {
    let b;
    return i("div", {
      ...
      class: "left"
    }, [C.value ? C.value : T.value]), i("div", {
      class: "right"
    }, [C.value && T.value, i("div", {
      class: "actions"
    }, [U.value]), a.options && i("div", {
      class: "options"
    }, [i(De, {
      content: "刷新",
      placement: "top"
...
}), ln = sn, zt = /* @__PURE__ */ Dt((e) => {
  const t = Nt("tableProps", {}), {
    ctx: a,
    columnEmptyText: n,
    cellAlign: s
  } = t, m = ie(() => (u) => u.ellipsis != null ? u.ellipsis : t.ellipsis), g = (u) => {
    const {
      filters: x,
      valueOption: E = []
    } = u;
    ...
    switch (u) {
      ...
      case "rate":
        const b = Number.isNaN(p) ? 0 : p > 5 ? 5 : p;
        return i(Kr, {
          modelValue: b,
          size: "large",
      ...
      case "progress":
        const P = Number.isNaN(p) ? 0 : p > 100 ? 100 : p;
        return i(Hr, {
          percentage: P,
          style: "flex: 1"
        }, null);
    ...
    if (E && a.slots[E] || p && a.slots[p]) {
      const V = E || p;
      return (ae = (Q = a.slots)[V]) == null ? void 0 : ae.call(Q, u.row);
    }
    let q = E ? u.row[E] : "-";
    if (p) {
      if (p == "index")
    ...
    if (p === void 0 && b) {
      const V = E ? u.row[E] : "", Z = b[V], Ce = typeof Z == "object" && Z.status ? "red" : void 0;
      q = typeof Z == "object" && Object.prototype.toString.call(Z) == "[object Object]" ? i(qr, {
        size: 5
      }, {
        default: () => [Ce && i("span", {
          class: `dot ${Z.status}`,
    ...
    let F = "-";
    typeof n == "boolean" ? F = n ? "-" : "" : F = n || F;
    const G = (Y = z == null ? void 0 : z(u.row)) != null ? Y : q;
    return G ? i(ut, null, [G, " ", x.copyable && i(xt, {
      class: "copyable"
    }, {
      default: () => [i(aa, null, null)]
    })]) : F;
  };
  return () => i(ut, null, [e.columns.map((u) => i(_r, {
    prop: u.dataField,
    label: u.title,
    type: u.valueType,
    sortable: u.sorter,
    ...
    fixed: u.fixed,
    filters: g(u),
    "show-overflow-tooltip": m.value(u),
    key: u.dataField
  }, {
    default: (x) => u.children && u.children.length ? i(zt, {
      columns: u.children
    }, null) : U(x, u)
  }))]);
});
...
const dn = typeof crypto != "undefined" && crypto.randomUUID && crypto.randomUUID.bind(crypto), cr = {
  randomUUID: dn
};
function hn(e, t, a) {
...
const mr = /* @__PURE__ */ Dt((e, t) => {
  const {
    ...
    dataSource: U,
    request: u
  } = e, x = W(a), E = W(!1), p = W({}), b = W(), P = W(), B = W([]), z = W("block"), q = W({
    data: [],
    total: 0
  }), F = W({
    current: 1,
  ...
  }), Y = ie(() => t.slots.title || t.slots.title), V = ie(() => {
    var w;
  ...
  }), Z = ie(() => Q.value ? G.value : V.value), Ce = ie(() => {
    var w;
    return {
      display: "flex",
    ...
    const {
      ...
      valueType: X,
      valueEnum: ee
    } = l, ue = typeof l.search == "object" ? l.search : {}, le = typeof n == "object" ? n : {};
    return {
      label: A,
      dataField: w,
      valueType: X,
      valueOptions: ee ? Lr(ee) : void 0,
      ...le,
      ...ue
    };
  }, Be = (l, ...w) => {
    ...
    if (u && typeof u == "function" && !x.value)
      try {
        x.value = !0;
        const w = Be(F.value), A = {
          ...F.value
        };
        delete A.current, delete A.pageSize, q.value = await u(w, {
          ...p.value,
          ...A,
          ...l
        });
    ...
    if (w == F.value.current && F.value.pageSize == A)
      return j(l);
    F.value.current = w, F.value.pageSize = A;
  }, H = (l = {}) => {
    U || j(l);
  }, J = () => {
    ...
    if (console.log(p.value, "searchForm.value"), Ae(p.value))
      return Yr.warning("筛选栏表单信息为空");
    j();
  }, ve = () => {
  ...
  }), T !== !1 && q.value.total > 0 && i("div", {
    class: "pagination-container",
    style: Ce.value
  }, [i(Jr, {
    "current-page": F.value.current,
    "onUpdate:current-page": [(l) => F.value.current = l, (l) => ne("current", l)],
    background: !0,
    total: q.value.total,
