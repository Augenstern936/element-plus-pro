...
const ProFieldCheckbox = defineComponent(
  (props, ctx) => {
    ...
    return () => {
      var _a;
      return /* @__PURE__ */ React.createElement(ElCheckboxGroup, { "v-model": state.value }, (_a = props.options) == null ? void 0 : _a.map((option, i) => /* @__PURE__ */ React.createElement(React.Fragment, null, props.type == "checkbox" ? /* @__PURE__ */ React.createElement(ElCheckbox, { ...option, key: i }) : /* @__PURE__ */ React.createElement(ElCheckboxButton, { ...option, key: i }, option.label))));
    };
  },
  {
